...
#include <dlrm.h>
#include "compute_embedding_reduce.hpp"

using namespace dlrm_embedding_reduce_ns;
...
#pragma HLS INTERFACE m_axi port=table_HBM8 offset=slave bundle  = gmem15
#pragma HLS INTERFACE m_axi port=table_HBM9 offset=slave bundle  = gmem16
#pragma HLS INTERFACE m_axi port=table_HBM10 offset=slave bundle = gmem17
#pragma HLS INTERFACE m_axi port=table_HBM11 offset=slave bundle = gmem18
#pragma HLS INTERFACE m_axi port=table_HBM12 offset=slave bundle = gmem19
#pragma HLS INTERFACE m_axi port=table_HBM13 offset=slave bundle = gmem20
#pragma HLS INTERFACE m_axi port=table_HBM14 offset=slave bundle = gmem21
#pragma HLS INTERFACE m_axi port=table_HBM15 offset=slave bundle = gmem22
// #pragma HLS INTERFACE m_axi port=table_HBM16 offset=slave bundle = gmem23
// #pragma HLS INTERFACE m_axi port=table_HBM17 offset=slave bundle = gmem24
// #pragma HLS INTERFACE m_axi port=table_HBM18 offset=slave bundle = gmem25
// #pragma HLS INTERFACE m_axi port=table_HBM19 offset=slave bundle = gmem26
// #pragma HLS INTERFACE m_axi port=table_HBM20 offset=slave bundle = gmem27
// #pragma HLS INTERFACE m_axi port=table_HBM21 offset=slave bundle = gmem28
// #pragma HLS INTERFACE m_axi port=table_HBM22 offset=slave bundle = gmem29
// #pragma HLS INTERFACE m_axi port=table_HBM23 offset=slave bundle = gmem30
// #pragma HLS INTERFACE m_axi port=table_HBM24 offset=slave bundle = gmem31
...
// #pragma HLS stream variable=s_embedding_buffer_wide_HBM28_2 depth=depth_s_embedding_buffer_wide_HBM28
...
#pragma HLS dataflow disable_start_propagation
    ...
    load_single_embedding_2_tables<ADDR_AXI_HBM_8, AXI_PADDED_SIZE_HBM_8, ADDR_AXI_HBM_40, AXI_PADDED_SIZE_HBM_40, EMBEDDING_ROW_PER_PE1>(
        s_idx_buffer_HBM8, table_HBM8, s_embedding_buffer_HBM8);
    load_single_embedding_2_tables<ADDR_AXI_HBM_9, AXI_PADDED_SIZE_HBM_9, ADDR_AXI_HBM_41, AXI_PADDED_SIZE_HBM_41, EMBEDDING_ROW_PER_PE1>(
        s_idx_buffer_HBM9, table_HBM9, s_embedding_buffer_HBM9);
    load_single_embedding_2_tables<ADDR_AXI_HBM_10, AXI_PADDED_SIZE_HBM_10, ADDR_AXI_HBM_42, AXI_PADDED_SIZE_HBM_42, EMBEDDING_ROW_PER_PE1>(
        s_idx_buffer_HBM10, table_HBM10, s_embedding_buffer_HBM10);
    load_single_embedding_2_tables<ADDR_AXI_HBM_11, AXI_PADDED_SIZE_HBM_11, ADDR_AXI_HBM_43, AXI_PADDED_SIZE_HBM_43, EMBEDDING_ROW_PER_PE1>(
        s_idx_buffer_HBM11, table_HBM11, s_embedding_buffer_HBM11);
    load_single_embedding_2_tables<ADDR_AXI_HBM_12, AXI_PADDED_SIZE_HBM_12, ADDR_AXI_HBM_44, AXI_PADDED_SIZE_HBM_44, EMBEDDING_ROW_PER_PE1>(
        s_idx_buffer_HBM12, table_HBM12, s_embedding_buffer_HBM12);
    load_single_embedding_2_tables<ADDR_AXI_HBM_13, AXI_PADDED_SIZE_HBM_13, ADDR_AXI_HBM_45, AXI_PADDED_SIZE_HBM_45, EMBEDDING_ROW_PER_PE1>(
        s_idx_buffer_HBM13, table_HBM13, s_embedding_buffer_HBM13);
    load_single_embedding_2_tables<ADDR_AXI_HBM_14, AXI_PADDED_SIZE_HBM_14, ADDR_AXI_HBM_46, AXI_PADDED_SIZE_HBM_46, EMBEDDING_ROW_PER_PE1>(
        s_idx_buffer_HBM14, table_HBM14, s_embedding_buffer_HBM14);
    load_single_embedding_2_tables<ADDR_AXI_HBM_15, AXI_PADDED_SIZE_HBM_15, ADDR_AXI_HBM_47, AXI_PADDED_SIZE_HBM_47, EMBEDDING_ROW_PER_PE1>(
        s_idx_buffer_HBM15, table_HBM15, s_embedding_buffer_HBM15);
    // load_single_embedding_2_tables<ADDR_AXI_HBM_16, AXI_PADDED_SIZE_HBM_16, ADDR_AXI_HBM_48, AXI_PADDED_SIZE_HBM_48, EMBEDDING_ROW_PER_PE1>(
    //     s_idx_buffer_HBM16, table_HBM16, s_embedding_buffer_HBM16);
    // load_single_embedding_2_tables<ADDR_AXI_HBM_17, AXI_PADDED_SIZE_HBM_17, ADDR_AXI_HBM_49, AXI_PADDED_SIZE_HBM_49, EMBEDDING_ROW_PER_PE1>(
    //     s_idx_buffer_HBM17, table_HBM17, s_embedding_buffer_HBM17);
    // load_single_embedding_2_tables<ADDR_AXI_HBM_18, AXI_PADDED_SIZE_HBM_18, ADDR_AXI_HBM_50, AXI_PADDED_SIZE_HBM_50, EMBEDDING_ROW_PER_PE1>(
    //     s_idx_buffer_HBM18, table_HBM18, s_embedding_buffer_HBM18);
    // load_single_embedding_2_tables<ADDR_AXI_HBM_19, AXI_PADDED_SIZE_HBM_19, ADDR_AXI_HBM_51, AXI_PADDED_SIZE_HBM_51, EMBEDDING_ROW_PER_PE1>(
    //     s_idx_buffer_HBM19, table_HBM19, s_embedding_buffer_HBM19);
    // load_single_embedding_2_tables<ADDR_AXI_HBM_20, AXI_PADDED_SIZE_HBM_20, ADDR_AXI_HBM_52, AXI_PADDED_SIZE_HBM_52, EMBEDDING_ROW_PER_PE1>(
    //     s_idx_buffer_HBM20, table_HBM20, s_embedding_buffer_HBM20);
    // load_single_embedding_2_tables<ADDR_AXI_HBM_21, AXI_PADDED_SIZE_HBM_21, ADDR_AXI_HBM_53, AXI_PADDED_SIZE_HBM_53, EMBEDDING_ROW_PER_PE1>(
    //     s_idx_buffer_HBM21, table_HBM21, s_embedding_buffer_HBM21);
    // load_single_embedding_2_tables<ADDR_AXI_HBM_22, AXI_PADDED_SIZE_HBM_22, ADDR_AXI_HBM_54, AXI_PADDED_SIZE_HBM_54, EMBEDDING_ROW_PER_PE1>(
    //     s_idx_buffer_HBM22, table_HBM22, s_embedding_buffer_HBM22);
    // load_single_embedding_2_tables<ADDR_AXI_HBM_23, AXI_PADDED_SIZE_HBM_23, ADDR_AXI_HBM_55, AXI_PADDED_SIZE_HBM_55, EMBEDDING_ROW_PER_PE1>(
    //      s_idx_buffer_HBM23, table_HBM23, s_embedding_buffer_HBM23);
    // load_single_embedding_2_tables<ADDR_AXI_HBM_24, AXI_PADDED_SIZE_HBM_24, ADDR_AXI_HBM_56, AXI_PADDED_SIZE_HBM_56, EMBEDDING_ROW_PER_PE1>(
    ...
    int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_8, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM8, s_embedding_buffer_wide_HBM8_1);
    int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_9, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM9, s_embedding_buffer_wide_HBM9_1);
    int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_10, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM10, s_embedding_buffer_wide_HBM10_1);
    int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_11, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM11, s_embedding_buffer_wide_HBM11_1);
    int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_12, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM12, s_embedding_buffer_wide_HBM12_1);
    int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_13, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM13, s_embedding_buffer_wide_HBM13_1);
    int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_14, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM14, s_embedding_buffer_wide_HBM14_1);
    int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_15, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM15, s_embedding_buffer_wide_HBM15_1);
    // int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_16, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM16, s_embedding_buffer_wide_HBM16_1);
    // int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_17, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM17, s_embedding_buffer_wide_HBM17_1);
    // int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_18, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM18, s_embedding_buffer_wide_HBM18_1);
    // int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_19, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM19, s_embedding_buffer_wide_HBM19_1);
    // int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_20, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM20, s_embedding_buffer_wide_HBM20_1);
    // int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_21, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM21, s_embedding_buffer_wide_HBM21_1);
    // int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_22, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM22, s_embedding_buffer_wide_HBM22_1);
    // int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_23, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM23, s_embedding_buffer_wide_HBM23_1);
    // int_to_wide<t_axi, VECTOR_SIZE_HBM_BANK_24, EMBEDDING_ROW_PER_PE1>(s_embedding_buffer_HBM24, s_embedding_buffer_wide_HBM24_1);
    ...
    gather_embeddings_8<VECTOR_SIZE_HBM_BANK_0, VECTOR_SIZE_HBM_BANK_1, VECTOR_SIZE_HBM_BANK_2, VECTOR_SIZE_HBM_BANK_3, VECTOR_SIZE_HBM_BANK_4, VECTOR_SIZE_HBM_BANK_5, VECTOR_SIZE_HBM_BANK_6, VECTOR_SIZE_HBM_BANK_7, EMBEDDING_ROW_PER_PE1>(
        ...
        s_embedding_0);
    gather_embeddings_8<VECTOR_SIZE_HBM_BANK_8, VECTOR_SIZE_HBM_BANK_9, VECTOR_SIZE_HBM_BANK_10, VECTOR_SIZE_HBM_BANK_11, VECTOR_SIZE_HBM_BANK_12, VECTOR_SIZE_HBM_BANK_13, VECTOR_SIZE_HBM_BANK_14, VECTOR_SIZE_HBM_BANK_15, EMBEDDING_ROW_PER_PE1>(
        s_embedding_buffer_wide_HBM8_1,
        s_embedding_buffer_wide_HBM9_1,
        s_embedding_buffer_wide_HBM10_1,
        s_embedding_buffer_wide_HBM11_1,
        s_embedding_buffer_wide_HBM12_1,
        s_embedding_buffer_wide_HBM13_1,
        s_embedding_buffer_wide_HBM14_1,
        s_embedding_buffer_wide_HBM15_1,
        s_embedding_1);
    // gather_embeddings_9<VECTOR_SIZE_HBM_BANK_16, VECTOR_SIZE_HBM_BANK_17, VECTOR_SIZE_HBM_BANK_18, VECTOR_SIZE_HBM_BANK_19, VECTOR_SIZE_HBM_BANK_20, VECTOR_SIZE_HBM_BANK_21, VECTOR_SIZE_HBM_BANK_22, VECTOR_SIZE_HBM_BANK_23, VECTOR_SIZE_HBM_BANK_24, EMBEDDING_ROW_PER_PE1>(
    //     s_embedding_buffer_wide_HBM16_1, 
    //     s_embedding_buffer_wide_HBM17_1, 
    //     s_embedding_buffer_wide_HBM18_1, 
    //     s_embedding_buffer_wide_HBM19_1, 
    //     s_embedding_buffer_wide_HBM20_1, 
    //     s_embedding_buffer_wide_HBM21_1, 
    //     s_embedding_buffer_wide_HBM22_1, 
    //     s_embedding_buffer_wide_HBM23_1, 
    //     s_embedding_buffer_wide_HBM24_1, 
    //     s_embedding_2);

    // gather_embeddings<EMBEDDING_ROW_PER_PE1>(s_embedding_0, s_embedding_1, s_embedding_2, s_feature_in);
    gather_embeddings<EMBEDDING_ROW_PER_PE1>(s_embedding_0, s_embedding_1, s_feature_in);

    store_features<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1>(s_feature_in, s_feature_out, s_embedding_table);

    replicate_feature_in_16<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1>(
        s_feature_out, 
    ...
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE32_0, s_feature1_PE32_1, s_result1_PE32);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE33_0, s_feature1_PE33_1, s_result1_PE33);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE34_0, s_feature1_PE34_1, s_result1_PE34);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE35_0, s_feature1_PE35_1, s_result1_PE35);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE36_0, s_feature1_PE36_1, s_result1_PE36);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE37_0, s_feature1_PE37_1, s_result1_PE37);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE38_0, s_feature1_PE38_1, s_result1_PE38);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE39_0, s_feature1_PE39_1, s_result1_PE39);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE40_0, s_feature1_PE40_1, s_result1_PE40);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE41_0, s_feature1_PE41_1, s_result1_PE41);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE42_0, s_feature1_PE42_1, s_result1_PE42);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE43_0, s_feature1_PE43_1, s_result1_PE43);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE44_0, s_feature1_PE44_1, s_result1_PE44);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE45_0, s_feature1_PE45_1, s_result1_PE45);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE46_0, s_feature1_PE46_1, s_result1_PE46);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE47_0, s_feature1_PE47_1, s_result1_PE47);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE48_0, s_feature1_PE48_1, s_result1_PE48);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE49_0, s_feature1_PE49_1, s_result1_PE49);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE50_0, s_feature1_PE50_1, s_result1_PE50);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE51_0, s_feature1_PE51_1, s_result1_PE51);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE52_0, s_feature1_PE52_1, s_result1_PE52);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE53_0, s_feature1_PE53_1, s_result1_PE53);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE54_0, s_feature1_PE54_1, s_result1_PE54);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE55_0, s_feature1_PE55_1, s_result1_PE55);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE56_0, s_feature1_PE56_1, s_result1_PE56);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE57_0, s_feature1_PE57_1, s_result1_PE57);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE58_0, s_feature1_PE58_1, s_result1_PE58);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE59_0, s_feature1_PE59_1, s_result1_PE59);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE60_0, s_feature1_PE60_1, s_result1_PE60);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE61_0, s_feature1_PE61_1, s_result1_PE61);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE62_0, s_feature1_PE62_1, s_result1_PE62);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE63_0, s_feature1_PE63_1, s_result1_PE63);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE64_0, s_feature1_PE64_1, s_result1_PE64);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE65_0, s_feature1_PE65_1, s_result1_PE65);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE66_0, s_feature1_PE66_1, s_result1_PE66);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE67_0, s_feature1_PE67_1, s_result1_PE67);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE68_0, s_feature1_PE68_1, s_result1_PE68);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE69_0, s_feature1_PE69_1, s_result1_PE69);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE70_0, s_feature1_PE70_1, s_result1_PE70);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE71_0, s_feature1_PE71_1, s_result1_PE71);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE72_0, s_feature1_PE72_1, s_result1_PE72);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE73_0, s_feature1_PE73_1, s_result1_PE73);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE74_0, s_feature1_PE74_1, s_result1_PE74);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE75_0, s_feature1_PE75_1, s_result1_PE75);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE76_0, s_feature1_PE76_1, s_result1_PE76);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE77_0, s_feature1_PE77_1, s_result1_PE77);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE78_0, s_feature1_PE78_1, s_result1_PE78);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE79_0, s_feature1_PE79_1, s_result1_PE79);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE80_0, s_feature1_PE80_1, s_result1_PE80);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE81_0, s_feature1_PE81_1, s_result1_PE81);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE82_0, s_feature1_PE82_1, s_result1_PE82);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE83_0, s_feature1_PE83_1, s_result1_PE83);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE84_0, s_feature1_PE84_1, s_result1_PE84);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE85_0, s_feature1_PE85_1, s_result1_PE85);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE86_0, s_feature1_PE86_1, s_result1_PE86);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE87_0, s_feature1_PE87_1, s_result1_PE87);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE88_0, s_feature1_PE88_1, s_result1_PE88);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE89_0, s_feature1_PE89_1, s_result1_PE89);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE90_0, s_feature1_PE90_1, s_result1_PE90);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE91_0, s_feature1_PE91_1, s_result1_PE91);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE92_0, s_feature1_PE92_1, s_result1_PE92);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE93_0, s_feature1_PE93_1, s_result1_PE93);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE94_0, s_feature1_PE94_1, s_result1_PE94);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE95_0, s_feature1_PE95_1, s_result1_PE95);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE96_0, s_feature1_PE96_1, s_result1_PE96);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE97_0, s_feature1_PE97_1, s_result1_PE97);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE98_0, s_feature1_PE98_1, s_result1_PE98);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE99_0, s_feature1_PE99_1, s_result1_PE99);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE100_0, s_feature1_PE100_1, s_result1_PE100);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE101_0, s_feature1_PE101_1, s_result1_PE101);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE102_0, s_feature1_PE102_1, s_result1_PE102);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE103_0, s_feature1_PE103_1, s_result1_PE103);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE104_0, s_feature1_PE104_1, s_result1_PE104);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE105_0, s_feature1_PE105_1, s_result1_PE105);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE106_0, s_feature1_PE106_1, s_result1_PE106);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE107_0, s_feature1_PE107_1, s_result1_PE107);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE108_0, s_feature1_PE108_1, s_result1_PE108);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE109_0, s_feature1_PE109_1, s_result1_PE109);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE110_0, s_feature1_PE110_1, s_result1_PE110);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE111_0, s_feature1_PE111_1, s_result1_PE111);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE112_0, s_feature1_PE112_1, s_result1_PE112);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE113_0, s_feature1_PE113_1, s_result1_PE113);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE114_0, s_feature1_PE114_1, s_result1_PE114);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE115_0, s_feature1_PE115_1, s_result1_PE115);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE116_0, s_feature1_PE116_1, s_result1_PE116);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE117_0, s_feature1_PE117_1, s_result1_PE117);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE118_0, s_feature1_PE118_1, s_result1_PE118);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE119_0, s_feature1_PE119_1, s_result1_PE119);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE120_0, s_feature1_PE120_1, s_result1_PE120);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE121_0, s_feature1_PE121_1, s_result1_PE121);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE122_0, s_feature1_PE122_1, s_result1_PE122);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE123_0, s_feature1_PE123_1, s_result1_PE123);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE124_0, s_feature1_PE124_1, s_result1_PE124);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE125_0, s_feature1_PE125_1, s_result1_PE125);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE126_0, s_feature1_PE126_1, s_result1_PE126);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE127_0, s_feature1_PE127_1, s_result1_PE127);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE128_0, s_feature1_PE128_1, s_result1_PE128);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE129_0, s_feature1_PE129_1, s_result1_PE129);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE130_0, s_feature1_PE130_1, s_result1_PE130);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE131_0, s_feature1_PE131_1, s_result1_PE131);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE132_0, s_feature1_PE132_1, s_result1_PE132);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE133_0, s_feature1_PE133_1, s_result1_PE133);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE134_0, s_feature1_PE134_1, s_result1_PE134);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE135_0, s_feature1_PE135_1, s_result1_PE135);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE136_0, s_feature1_PE136_1, s_result1_PE136);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE137_0, s_feature1_PE137_1, s_result1_PE137);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE138_0, s_feature1_PE138_1, s_result1_PE138);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE139_0, s_feature1_PE139_1, s_result1_PE139);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE140_0, s_feature1_PE140_1, s_result1_PE140);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE141_0, s_feature1_PE141_1, s_result1_PE141);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE142_0, s_feature1_PE142_1, s_result1_PE142);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE143_0, s_feature1_PE143_1, s_result1_PE143);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE144_0, s_feature1_PE144_1, s_result1_PE144);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE145_0, s_feature1_PE145_1, s_result1_PE145);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE146_0, s_feature1_PE146_1, s_result1_PE146);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE147_0, s_feature1_PE147_1, s_result1_PE147);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE148_0, s_feature1_PE148_1, s_result1_PE148);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE149_0, s_feature1_PE149_1, s_result1_PE149);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE150_0, s_feature1_PE150_1, s_result1_PE150);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE151_0, s_feature1_PE151_1, s_result1_PE151);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE152_0, s_feature1_PE152_1, s_result1_PE152);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE153_0, s_feature1_PE153_1, s_result1_PE153);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE154_0, s_feature1_PE154_1, s_result1_PE154);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE155_0, s_feature1_PE155_1, s_result1_PE155);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE156_0, s_feature1_PE156_1, s_result1_PE156);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE157_0, s_feature1_PE157_1, s_result1_PE157);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE158_0, s_feature1_PE158_1, s_result1_PE158);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE159_0, s_feature1_PE159_1, s_result1_PE159);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE160_0, s_feature1_PE160_1, s_result1_PE160);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE161_0, s_feature1_PE161_1, s_result1_PE161);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE162_0, s_feature1_PE162_1, s_result1_PE162);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE163_0, s_feature1_PE163_1, s_result1_PE163);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE164_0, s_feature1_PE164_1, s_result1_PE164);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE165_0, s_feature1_PE165_1, s_result1_PE165);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE166_0, s_feature1_PE166_1, s_result1_PE166);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE167_0, s_feature1_PE167_1, s_result1_PE167);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE168_0, s_feature1_PE168_1, s_result1_PE168);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE169_0, s_feature1_PE169_1, s_result1_PE169);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE170_0, s_feature1_PE170_1, s_result1_PE170);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE171_0, s_feature1_PE171_1, s_result1_PE171);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE172_0, s_feature1_PE172_1, s_result1_PE172);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE173_0, s_feature1_PE173_1, s_result1_PE173);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE174_0, s_feature1_PE174_1, s_result1_PE174);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE175_0, s_feature1_PE175_1, s_result1_PE175);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE176_0, s_feature1_PE176_1, s_result1_PE176);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE177_0, s_feature1_PE177_1, s_result1_PE177);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE178_0, s_feature1_PE178_1, s_result1_PE178);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE179_0, s_feature1_PE179_1, s_result1_PE179);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE180_0, s_feature1_PE180_1, s_result1_PE180);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE181_0, s_feature1_PE181_1, s_result1_PE181);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE182_0, s_feature1_PE182_1, s_result1_PE182);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE183_0, s_feature1_PE183_1, s_result1_PE183);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE184_0, s_feature1_PE184_1, s_result1_PE184);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE185_0, s_feature1_PE185_1, s_result1_PE185);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE186_0, s_feature1_PE186_1, s_result1_PE186);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE187_0, s_feature1_PE187_1, s_result1_PE187);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE188_0, s_feature1_PE188_1, s_result1_PE188);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE189_0, s_feature1_PE189_1, s_result1_PE189);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE190_0, s_feature1_PE190_1, s_result1_PE190);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE191_0, s_feature1_PE191_1, s_result1_PE191);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE192_0, s_feature1_PE192_1, s_result1_PE192);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE193_0, s_feature1_PE193_1, s_result1_PE193);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE194_0, s_feature1_PE194_1, s_result1_PE194);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE195_0, s_feature1_PE195_1, s_result1_PE195);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE196_0, s_feature1_PE196_1, s_result1_PE196);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE197_0, s_feature1_PE197_1, s_result1_PE197);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE198_0, s_feature1_PE198_1, s_result1_PE198);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE199_0, s_feature1_PE199_1, s_result1_PE199);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE200_0, s_feature1_PE200_1, s_result1_PE200);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE201_0, s_feature1_PE201_1, s_result1_PE201);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE202_0, s_feature1_PE202_1, s_result1_PE202);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE203_0, s_feature1_PE203_1, s_result1_PE203);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE204_0, s_feature1_PE204_1, s_result1_PE204);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE205_0, s_feature1_PE205_1, s_result1_PE205);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE206_0, s_feature1_PE206_1, s_result1_PE206);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE207_0, s_feature1_PE207_1, s_result1_PE207);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE208_0, s_feature1_PE208_1, s_result1_PE208);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE209_0, s_feature1_PE209_1, s_result1_PE209);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE210_0, s_feature1_PE210_1, s_result1_PE210);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE211_0, s_feature1_PE211_1, s_result1_PE211);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE212_0, s_feature1_PE212_1, s_result1_PE212);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE213_0, s_feature1_PE213_1, s_result1_PE213);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE214_0, s_feature1_PE214_1, s_result1_PE214);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE215_0, s_feature1_PE215_1, s_result1_PE215);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE216_0, s_feature1_PE216_1, s_result1_PE216);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE217_0, s_feature1_PE217_1, s_result1_PE217);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE218_0, s_feature1_PE218_1, s_result1_PE218);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE219_0, s_feature1_PE219_1, s_result1_PE219);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE220_0, s_feature1_PE220_1, s_result1_PE220);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE221_0, s_feature1_PE221_1, s_result1_PE221);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE222_0, s_feature1_PE222_1, s_result1_PE222);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE223_0, s_feature1_PE223_1, s_result1_PE223);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE224_0, s_feature1_PE224_1, s_result1_PE224);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE225_0, s_feature1_PE225_1, s_result1_PE225);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE226_0, s_feature1_PE226_1, s_result1_PE226);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE227_0, s_feature1_PE227_1, s_result1_PE227);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE228_0, s_feature1_PE228_1, s_result1_PE228);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE229_0, s_feature1_PE229_1, s_result1_PE229);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE230_0, s_feature1_PE230_1, s_result1_PE230);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE231_0, s_feature1_PE231_1, s_result1_PE231);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE232_0, s_feature1_PE232_1, s_result1_PE232);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE233_0, s_feature1_PE233_1, s_result1_PE233);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE234_0, s_feature1_PE234_1, s_result1_PE234);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE235_0, s_feature1_PE235_1, s_result1_PE235);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE236_0, s_feature1_PE236_1, s_result1_PE236);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE237_0, s_feature1_PE237_1, s_result1_PE237);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE238_0, s_feature1_PE238_1, s_result1_PE238);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE239_0, s_feature1_PE239_1, s_result1_PE239);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE240_0, s_feature1_PE240_1, s_result1_PE240);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE241_0, s_feature1_PE241_1, s_result1_PE241);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE242_0, s_feature1_PE242_1, s_result1_PE242);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE243_0, s_feature1_PE243_1, s_result1_PE243);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE244_0, s_feature1_PE244_1, s_result1_PE244);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE245_0, s_feature1_PE245_1, s_result1_PE245);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE246_0, s_feature1_PE246_1, s_result1_PE246);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE247_0, s_feature1_PE247_1, s_result1_PE247);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE248_0, s_feature1_PE248_1, s_result1_PE248);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE249_0, s_feature1_PE249_1, s_result1_PE249);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE250_0, s_feature1_PE250_1, s_result1_PE250);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE251_0, s_feature1_PE251_1, s_result1_PE251);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE252_0, s_feature1_PE252_1, s_result1_PE252);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE253_0, s_feature1_PE253_1, s_result1_PE253);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE254_0, s_feature1_PE254_1, s_result1_PE254);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE255_0, s_feature1_PE255_1, s_result1_PE255);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE256_0, s_feature1_PE256_1, s_result1_PE256);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE257_0, s_feature1_PE257_1, s_result1_PE257);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE258_0, s_feature1_PE258_1, s_result1_PE258);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE259_0, s_feature1_PE259_1, s_result1_PE259);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE260_0, s_feature1_PE260_1, s_result1_PE260);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE261_0, s_feature1_PE261_1, s_result1_PE261);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE262_0, s_feature1_PE262_1, s_result1_PE262);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE263_0, s_feature1_PE263_1, s_result1_PE263);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE264_0, s_feature1_PE264_1, s_result1_PE264);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE265_0, s_feature1_PE265_1, s_result1_PE265);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE266_0, s_feature1_PE266_1, s_result1_PE266);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE267_0, s_feature1_PE267_1, s_result1_PE267);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE268_0, s_feature1_PE268_1, s_result1_PE268);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE269_0, s_feature1_PE269_1, s_result1_PE269);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE270_0, s_feature1_PE270_1, s_result1_PE270);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE271_0, s_feature1_PE271_1, s_result1_PE271);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE272_0, s_feature1_PE272_1, s_result1_PE272);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE273_0, s_feature1_PE273_1, s_result1_PE273);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE274_0, s_feature1_PE274_1, s_result1_PE274);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE275_0, s_feature1_PE275_1, s_result1_PE275);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE276_0, s_feature1_PE276_1, s_result1_PE276);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE277_0, s_feature1_PE277_1, s_result1_PE277);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE278_0, s_feature1_PE278_1, s_result1_PE278);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE279_0, s_feature1_PE279_1, s_result1_PE279);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE280_0, s_feature1_PE280_1, s_result1_PE280);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE281_0, s_feature1_PE281_1, s_result1_PE281);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE282_0, s_feature1_PE282_1, s_result1_PE282);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE283_0, s_feature1_PE283_1, s_result1_PE283);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE284_0, s_feature1_PE284_1, s_result1_PE284);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE285_0, s_feature1_PE285_1, s_result1_PE285);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE286_0, s_feature1_PE286_1, s_result1_PE286);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE287_0, s_feature1_PE287_1, s_result1_PE287);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE288_0, s_feature1_PE288_1, s_result1_PE288);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE289_0, s_feature1_PE289_1, s_result1_PE289);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE290_0, s_feature1_PE290_1, s_result1_PE290);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE291_0, s_feature1_PE291_1, s_result1_PE291);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE292_0, s_feature1_PE292_1, s_result1_PE292);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE293_0, s_feature1_PE293_1, s_result1_PE293);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE294_0, s_feature1_PE294_1, s_result1_PE294);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE295_0, s_feature1_PE295_1, s_result1_PE295);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE296_0, s_feature1_PE296_1, s_result1_PE296);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE297_0, s_feature1_PE297_1, s_result1_PE297);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE298_0, s_feature1_PE298_1, s_result1_PE298);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE299_0, s_feature1_PE299_1, s_result1_PE299);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE300_0, s_feature1_PE300_1, s_result1_PE300);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE301_0, s_feature1_PE301_1, s_result1_PE301);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE302_0, s_feature1_PE302_1, s_result1_PE302);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE303_0, s_feature1_PE303_1, s_result1_PE303);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE304_0, s_feature1_PE304_1, s_result1_PE304);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE305_0, s_feature1_PE305_1, s_result1_PE305);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE306_0, s_feature1_PE306_1, s_result1_PE306);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE307_0, s_feature1_PE307_1, s_result1_PE307);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE308_0, s_feature1_PE308_1, s_result1_PE308);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE309_0, s_feature1_PE309_1, s_result1_PE309);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE310_0, s_feature1_PE310_1, s_result1_PE310);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE311_0, s_feature1_PE311_1, s_result1_PE311);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE312_0, s_feature1_PE312_1, s_result1_PE312);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE313_0, s_feature1_PE313_1, s_result1_PE313);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE314_0, s_feature1_PE314_1, s_result1_PE314);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE315_0, s_feature1_PE315_1, s_result1_PE315);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE316_0, s_feature1_PE316_1, s_result1_PE316);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE317_0, s_feature1_PE317_1, s_result1_PE317);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE318_0, s_feature1_PE318_1, s_result1_PE318);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE319_0, s_feature1_PE319_1, s_result1_PE319);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE320_0, s_feature1_PE320_1, s_result1_PE320);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE321_0, s_feature1_PE321_1, s_result1_PE321);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE322_0, s_feature1_PE322_1, s_result1_PE322);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE323_0, s_feature1_PE323_1, s_result1_PE323);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE324_0, s_feature1_PE324_1, s_result1_PE324);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE325_0, s_feature1_PE325_1, s_result1_PE325);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE326_0, s_feature1_PE326_1, s_result1_PE326);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE327_0, s_feature1_PE327_1, s_result1_PE327);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE328_0, s_feature1_PE328_1, s_result1_PE328);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE329_0, s_feature1_PE329_1, s_result1_PE329);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE330_0, s_feature1_PE330_1, s_result1_PE330);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE331_0, s_feature1_PE331_1, s_result1_PE331);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE332_0, s_feature1_PE332_1, s_result1_PE332);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE333_0, s_feature1_PE333_1, s_result1_PE333);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE334_0, s_feature1_PE334_1, s_result1_PE334);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE335_0, s_feature1_PE335_1, s_result1_PE335);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE336_0, s_feature1_PE336_1, s_result1_PE336);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE337_0, s_feature1_PE337_1, s_result1_PE337);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE338_0, s_feature1_PE338_1, s_result1_PE338);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE339_0, s_feature1_PE339_1, s_result1_PE339);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE340_0, s_feature1_PE340_1, s_result1_PE340);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE341_0, s_feature1_PE341_1, s_result1_PE341);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE342_0, s_feature1_PE342_1, s_result1_PE342);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE343_0, s_feature1_PE343_1, s_result1_PE343);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE344_0, s_feature1_PE344_1, s_result1_PE344);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE345_0, s_feature1_PE345_1, s_result1_PE345);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE346_0, s_feature1_PE346_1, s_result1_PE346);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE347_0, s_feature1_PE347_1, s_result1_PE347);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE348_0, s_feature1_PE348_1, s_result1_PE348);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE349_0, s_feature1_PE349_1, s_result1_PE349);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE350_0, s_feature1_PE350_1, s_result1_PE350);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE351_0, s_feature1_PE351_1, s_result1_PE351);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE352_0, s_feature1_PE352_1, s_result1_PE352);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE353_0, s_feature1_PE353_1, s_result1_PE353);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE354_0, s_feature1_PE354_1, s_result1_PE354);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE355_0, s_feature1_PE355_1, s_result1_PE355);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE356_0, s_feature1_PE356_1, s_result1_PE356);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE357_0, s_feature1_PE357_1, s_result1_PE357);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE358_0, s_feature1_PE358_1, s_result1_PE358);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE359_0, s_feature1_PE359_1, s_result1_PE359);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE360_0, s_feature1_PE360_1, s_result1_PE360);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE361_0, s_feature1_PE361_1, s_result1_PE361);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE362_0, s_feature1_PE362_1, s_result1_PE362);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE363_0, s_feature1_PE363_1, s_result1_PE363);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE364_0, s_feature1_PE364_1, s_result1_PE364);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE365_0, s_feature1_PE365_1, s_result1_PE365);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE366_0, s_feature1_PE366_1, s_result1_PE366);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE367_0, s_feature1_PE367_1, s_result1_PE367);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE368_0, s_feature1_PE368_1, s_result1_PE368);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE369_0, s_feature1_PE369_1, s_result1_PE369);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE370_0, s_feature1_PE370_1, s_result1_PE370);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE371_0, s_feature1_PE371_1, s_result1_PE371);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE372_0, s_feature1_PE372_1, s_result1_PE372);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE373_0, s_feature1_PE373_1, s_result1_PE373);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE374_0, s_feature1_PE374_1, s_result1_PE374);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE375_0, s_feature1_PE375_1, s_result1_PE375);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE376_0, s_feature1_PE376_1, s_result1_PE376);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE377_0, s_feature1_PE377_1, s_result1_PE377);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE378_0, s_feature1_PE378_1, s_result1_PE378);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE379_0, s_feature1_PE379_1, s_result1_PE379);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE380_0, s_feature1_PE380_1, s_result1_PE380);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE381_0, s_feature1_PE381_1, s_result1_PE381);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE382_0, s_feature1_PE382_1, s_result1_PE382);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE383_0, s_feature1_PE383_1, s_result1_PE383);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE384_0, s_feature1_PE384_1, s_result1_PE384);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE385_0, s_feature1_PE385_1, s_result1_PE385);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE386_0, s_feature1_PE386_1, s_result1_PE386);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE387_0, s_feature1_PE387_1, s_result1_PE387);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE388_0, s_feature1_PE388_1, s_result1_PE388);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE389_0, s_feature1_PE389_1, s_result1_PE389);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE390_0, s_feature1_PE390_1, s_result1_PE390);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE391_0, s_feature1_PE391_1, s_result1_PE391);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE392_0, s_feature1_PE392_1, s_result1_PE392);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE393_0, s_feature1_PE393_1, s_result1_PE393);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE394_0, s_feature1_PE394_1, s_result1_PE394);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE395_0, s_feature1_PE395_1, s_result1_PE395);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE396_0, s_feature1_PE396_1, s_result1_PE396);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE397_0, s_feature1_PE397_1, s_result1_PE397);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE398_0, s_feature1_PE398_1, s_result1_PE398);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE399_0, s_feature1_PE399_1, s_result1_PE399);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE400_0, s_feature1_PE400_1, s_result1_PE400);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE401_0, s_feature1_PE401_1, s_result1_PE401);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE402_0, s_feature1_PE402_1, s_result1_PE402);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE403_0, s_feature1_PE403_1, s_result1_PE403);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE404_0, s_feature1_PE404_1, s_result1_PE404);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE405_0, s_feature1_PE405_1, s_result1_PE405);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE406_0, s_feature1_PE406_1, s_result1_PE406);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE407_0, s_feature1_PE407_1, s_result1_PE407);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE408_0, s_feature1_PE408_1, s_result1_PE408);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE409_0, s_feature1_PE409_1, s_result1_PE409);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE410_0, s_feature1_PE410_1, s_result1_PE410);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE411_0, s_feature1_PE411_1, s_result1_PE411);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE412_0, s_feature1_PE412_1, s_result1_PE412);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE413_0, s_feature1_PE413_1, s_result1_PE413);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE414_0, s_feature1_PE414_1, s_result1_PE414);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE415_0, s_feature1_PE415_1, s_result1_PE415);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE416_0, s_feature1_PE416_1, s_result1_PE416);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE417_0, s_feature1_PE417_1, s_result1_PE417);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE418_0, s_feature1_PE418_1, s_result1_PE418);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE419_0, s_feature1_PE419_1, s_result1_PE419);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE420_0, s_feature1_PE420_1, s_result1_PE420);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE421_0, s_feature1_PE421_1, s_result1_PE421);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE422_0, s_feature1_PE422_1, s_result1_PE422);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE423_0, s_feature1_PE423_1, s_result1_PE423);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE424_0, s_feature1_PE424_1, s_result1_PE424);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE425_0, s_feature1_PE425_1, s_result1_PE425);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE426_0, s_feature1_PE426_1, s_result1_PE426);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE427_0, s_feature1_PE427_1, s_result1_PE427);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE428_0, s_feature1_PE428_1, s_result1_PE428);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE429_0, s_feature1_PE429_1, s_result1_PE429);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE430_0, s_feature1_PE430_1, s_result1_PE430);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE431_0, s_feature1_PE431_1, s_result1_PE431);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE432_0, s_feature1_PE432_1, s_result1_PE432);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE433_0, s_feature1_PE433_1, s_result1_PE433);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE434_0, s_feature1_PE434_1, s_result1_PE434);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE435_0, s_feature1_PE435_1, s_result1_PE435);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE436_0, s_feature1_PE436_1, s_result1_PE436);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE437_0, s_feature1_PE437_1, s_result1_PE437);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE438_0, s_feature1_PE438_1, s_result1_PE438);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE439_0, s_feature1_PE439_1, s_result1_PE439);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE440_0, s_feature1_PE440_1, s_result1_PE440);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE441_0, s_feature1_PE441_1, s_result1_PE441);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE442_0, s_feature1_PE442_1, s_result1_PE442);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE443_0, s_feature1_PE443_1, s_result1_PE443);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE444_0, s_feature1_PE444_1, s_result1_PE444);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE445_0, s_feature1_PE445_1, s_result1_PE445);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE446_0, s_feature1_PE446_1, s_result1_PE446);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE447_0, s_feature1_PE447_1, s_result1_PE447);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE448_0, s_feature1_PE448_1, s_result1_PE448);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE449_0, s_feature1_PE449_1, s_result1_PE449);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE450_0, s_feature1_PE450_1, s_result1_PE450);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE451_0, s_feature1_PE451_1, s_result1_PE451);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE452_0, s_feature1_PE452_1, s_result1_PE452);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE453_0, s_feature1_PE453_1, s_result1_PE453);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE454_0, s_feature1_PE454_1, s_result1_PE454);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE455_0, s_feature1_PE455_1, s_result1_PE455);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE456_0, s_feature1_PE456_1, s_result1_PE456);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE457_0, s_feature1_PE457_1, s_result1_PE457);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE458_0, s_feature1_PE458_1, s_result1_PE458);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE459_0, s_feature1_PE459_1, s_result1_PE459);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE460_0, s_feature1_PE460_1, s_result1_PE460);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE461_0, s_feature1_PE461_1, s_result1_PE461);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE462_0, s_feature1_PE462_1, s_result1_PE462);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE463_0, s_feature1_PE463_1, s_result1_PE463);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE464_0, s_feature1_PE464_1, s_result1_PE464);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE465_0, s_feature1_PE465_1, s_result1_PE465);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE466_0, s_feature1_PE466_1, s_result1_PE466);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE467_0, s_feature1_PE467_1, s_result1_PE467);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE468_0, s_feature1_PE468_1, s_result1_PE468);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE469_0, s_feature1_PE469_1, s_result1_PE469);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE470_0, s_feature1_PE470_1, s_result1_PE470);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE471_0, s_feature1_PE471_1, s_result1_PE471);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE472_0, s_feature1_PE472_1, s_result1_PE472);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE473_0, s_feature1_PE473_1, s_result1_PE473);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE474_0, s_feature1_PE474_1, s_result1_PE474);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE475_0, s_feature1_PE475_1, s_result1_PE475);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE476_0, s_feature1_PE476_1, s_result1_PE476);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE477_0, s_feature1_PE477_1, s_result1_PE477);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE478_0, s_feature1_PE478_1, s_result1_PE478);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE479_0, s_feature1_PE479_1, s_result1_PE479);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE480_0, s_feature1_PE480_1, s_result1_PE480);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE481_0, s_feature1_PE481_1, s_result1_PE481);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE482_0, s_feature1_PE482_1, s_result1_PE482);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE483_0, s_feature1_PE483_1, s_result1_PE483);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE484_0, s_feature1_PE484_1, s_result1_PE484);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE485_0, s_feature1_PE485_1, s_result1_PE485);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE486_0, s_feature1_PE486_1, s_result1_PE486);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE487_0, s_feature1_PE487_1, s_result1_PE487);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE488_0, s_feature1_PE488_1, s_result1_PE488);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE489_0, s_feature1_PE489_1, s_result1_PE489);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE490_0, s_feature1_PE490_1, s_result1_PE490);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE491_0, s_feature1_PE491_1, s_result1_PE491);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE492_0, s_feature1_PE492_1, s_result1_PE492);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE493_0, s_feature1_PE493_1, s_result1_PE493);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE494_0, s_feature1_PE494_1, s_result1_PE494);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE495_0, s_feature1_PE495_1, s_result1_PE495);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE496_0, s_feature1_PE496_1, s_result1_PE496);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE497_0, s_feature1_PE497_1, s_result1_PE497);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE498_0, s_feature1_PE498_1, s_result1_PE498);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE499_0, s_feature1_PE499_1, s_result1_PE499);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE500_0, s_feature1_PE500_1, s_result1_PE500);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE501_0, s_feature1_PE501_1, s_result1_PE501);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE502_0, s_feature1_PE502_1, s_result1_PE502);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE503_0, s_feature1_PE503_1, s_result1_PE503);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE504_0, s_feature1_PE504_1, s_result1_PE504);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE505_0, s_feature1_PE505_1, s_result1_PE505);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE506_0, s_feature1_PE506_1, s_result1_PE506);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE507_0, s_feature1_PE507_1, s_result1_PE507);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE508_0, s_feature1_PE508_1, s_result1_PE508);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE509_0, s_feature1_PE509_1, s_result1_PE509);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_BRAM>(s_feature1_PE510_0, s_feature1_PE510_1, s_result1_PE510);
    matmul_PE_UNROLL8<EMBEDDING_INPUT_SIZE, EMBEDDING_ROW_PER_PE1, WEIGHT_URAM>(s_feature1_PE511_0, s_feature1_PE511_1, s_result1_PE511);
    ...
    gather_results_32PEs<EMBEDDING_ROW_PER_PE1>(
        ...
        s_result1_partial_15); 

    gather_results_node1<EMBEDDING_ROW_PER_PE1>(
        s_result1_partial_0, s_result1_partial_1, s_result1_partial_2, s_result1_partial_3, 
        s_result1_partial_4, s_result1_partial_5, s_result1_partial_6, s_result1_partial_7, 
        s_result1_partial_8, s_result1_partial_9, s_result1_partial_10, s_result1_partial_11, 
        s_result1_partial_12, s_result1_partial_13, s_result1_partial_14, s_result1_partial_15, 
        s_result1_node1);
    ...
    accl.stream_put_nb(count_send, 9, destination, 0); 
    ...
    // tie off receiving data
    data.tie_off_cclo2krnl();

    #ifndef ACCL_SYNTHESIS
        std::cout << "dlrm_embedding_reduce: stream_put count=" << count_send << " destination=" << destination << "\n";
    #endif

    accl.finalize_call();

    #ifndef ACCL_SYNTHESIS
        std::cout << "dlrm_embedding_reduce: finish" << "\n";
    #endif
}
...
//     data.tie_off_cclo2krnl();
//     #ifndef ACCL_SYNTHESIS
//         std::cout << "dlrm_embedding_reduce: stream_put count=" << count << " destination=" << destination << "\n";
//     #endif
//     accl.finalize_call();
//     #ifndef ACCL_SYNTHESIS
//         std::cout << "dlrm_embedding_reduce: finish" << "\n";
